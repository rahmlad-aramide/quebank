      ...
      >
        <StyledView className="flex-1 items-center justify-center">
          ...
          <StyledView className="flex self-end">
            <StyledTouchableOpacity>
              <StyledText className="text-tertiary font-bold text-xs">Forgot password?</StyledText>
            </StyledTouchableOpacity>
          </StyledView>
          ...
          <StyledView className="flex flex-row items-center w-full mt-[30px]">
            ...
            <StyledText className="w-auto mx-2.5 -mt-1">
              or
              </StyledText>
            <StyledView className="flex w-auto flex-grow h-0.5 bg-black/30"></StyledView>
          </StyledView>
          <TouchableOpacity variant="outlined" icon={<GoogleIcon />}>Continue with Google</TouchableOpacity>
        </StyledView>
      </StyledScrollView>
    </StyledKeyboardAvoidingView>
  );
